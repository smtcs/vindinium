...
Bot.prototype.sendRequest = function (){
  ...
  return new Promise(function(resolve, reject){
    ...
    console.log("Running game at: " + _this.URL + ", with key: " + _this.key);    
    if(_this.gameStart === true){   
      ...
      if(_this.data.game.finished !== true){
        console.log("Going this direction: " + _this.goDir);
...
Bot.prototype.parseTheData = function (){
 return new Promise(function(resolve, reject){ 
  ...
  console.log(bot.map);
  console.log("Player 1 Gold: " + _this.data.game.heroes[0].gold + ". Player 2 Gold: " + _this.data.game.heroes[1].gold + ". Player 3 Gold: " + _this.data.game.heroes[2].gold + ". Player 4 Gold: " + _this.data.game.heroes[3].gold);
  resolve();  
})};
...
Bot.prototype.findPath = function(pos1, pos2){
    ...
    var grid = new PF.Grid(gridLength, gridLength, pathFinderMap);
