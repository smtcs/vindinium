...
Bot.prototype.startGame = function (callback){
  var _this = bot;
  ...
  request.post({url: _this.URL, form: {key: _this.key}}, function(err, res, body) {
      ...
      console.log(_this.data.viewUrl);
      _this.playURL = _this.data.playUrl;
      console.log(_this.data.playUrl);
  })
  callback();
};

Bot.prototype.newRequest = function(turnDir, callback){
...
Bot.prototype.parseTheData = function (callback){
  //console.log("bot.aPR is going");
  var _this = bot;
  ...
  if(_this.data === undefined){
    console.log("haha : " + _this.counter); 
   setTimeout(function(){bot.parseTheData(function(){
     console.log("yup");
      bot.botBrain(function(){
        console.log("bleh");
        bot.newRequest(bot.goDir, _this.runBot());
      })
    })} ,100);
  ...
  console.log("praseTheData: " + bot.data);
  _this.bot1 = {
    pos:{
  ...
  console.log("testing here" + callback);
...
Bot.prototype.runBot = function(){
  bot.startGame(function(){
    bot.parseTheData(function(){
      bot.botBrain(function(){
        bot.newRequest(bot.goDir, bot.parseTheData());
      })
    })
  })
}
