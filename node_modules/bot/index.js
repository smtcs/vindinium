...
Bot.prototype.requestAgain = function(turnDir, callback){
  var _this = bot;
  console.log(turnDir);
  if(_this.data.game.finished !== true){
      request.post({url: _this.playURL, form: {key: _this.key, dir: turnDir}}, function(err, res, body){
      console.log('run because finished is false');
      callback();
      })
  }
};
