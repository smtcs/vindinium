...
Bot.prototype.sendRequest = function (){
  ...
  return new Promise(function(resolve, reject){
    ...
    if(_this.gameStart === true){   
      ...
      request.post({url: _this.URL, form: {key: _this.key, map: "m1"}}, function(err, res, body) {
      ...
      if(_this.data.game.finished !== true){
        console.log("Going in this Direction! " + _this.goDir);
...
Bot.prototype.parseTheData = function (){
 ...
 // This Creates the Console Display    
    console.log(bot.map);
    console.log("Turn: " + bot.data.game.turn + " Of " + bot.data.game.maxTurns); 
    console.log("Bot 1 life: " + bot.data.game.heroes[0].life + ". Bot 2 life: " + bot.data.game.heroes[1].life + ". Bot 3 life: " + bot.data.game.heroes[2].life + ". Bot 4 life: " + bot.data.game.heroes[3].life )
    console.log("Bot 1 Mines: " + bot.data.game.heroes[0].mineCount + ". Bot 2 mines: " + bot.data.game.heroes[1].mineCount + ". Bot 3 mines: " + bot.data.game.heroes[2].mineCount + ". Bot 4 mines: " + bot.data.game.heroes[3].mineCount )
    console.log("Bot 1 Gold: " + bot.data.game.heroes[0].gold + ". Bot 2 Gold: " + bot.data.game.heroes[1].gold + ". Bot 3 Gold: " + bot.data.game.heroes[2].gold + ". Bot 4 Gold: " + bot.data.game.heroes[3].gold )
