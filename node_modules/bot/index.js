...
Bot.prototype.run = function (cb){
  ...
  request.post({url: this.URL, form: {key: "nwiltp4r"}}, function(err, res, body) {
      console.log(this.url);
      console.log("Logging the body! " + body);
      this.data = JSON.parse(body);
      console.log("this.data from the request post" + this.data.game.heroes[0].pos.x);
...
Bot.prototype.afterPostRequest = function (cb){
  console.log("this.data from outside the request post" + this.data);
  ...
  console.log("Bot1 Life " + this.bot1.life);
  this.bot2 = {
    pos:{
