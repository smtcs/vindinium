...
Bot.prototype.startGame = function (){
  ...
  request.post({url: _this.URL, form: {key: _this.key}}, function(err, res, body) {
      ...
      console.log("bot.data in startGame post :" + bot.data);
...
Bot.prototype.newRequest = function(turnDir, callback){
  ...
  if(_this.data.game.finished !== true){
      request.post({url: _this.data.playURL, form: {key: _this.key, dir: bot.goDir}}, function(err, res, body){
      console.log(_this.data.viewUrl);
      callback();
      })
  }
...
Bot.prototype.parseTheData = function (cb){
