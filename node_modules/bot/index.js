...
function Bot(key, mode, url) {
  ...
  bot = this;
  //console.log("from creation: " + bot);
}
Bot.prototype.run = function (cb){
  var _this = bot;
  //console.log("this be our bot: "+ bot.mode);
  //console.log("at the post!");  
  request.post({url: _this.URL, form: {key: "nwiltp4r"}}, function(err, res, body) {
      //console.log(_this.url);
     // console.log("I'm logging _this: "+ _this);
      _this.data = JSON.parse(body);
      console.log(_this.viewUrl);
      //console.log("_this.data from the request post" + _this.data.game.heroes[0].pos.x);
...
Bot.prototype.afterPostRequest = function (cb){
  var _this = bot;
  //console.log("_this.data from outside the request post" + _this.data.game.finished);
  if(_this.data.game.finished !== true) {
    setInterval(function() {
      request.post({url: _this.playURL, form: {key: _this.key, dir: cb(_this.data)}}, function(err, res, body){
        //console.log('run');
      });
    }, 500);
  };
  ...
  console.log("Bot1 Life " + _this.bot1.life);
  _this.bot2 = {
    pos:{
  ...
  console.log("this is tempMapSize: " + tempMapSize);
